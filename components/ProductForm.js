    ...
    return (
        <form onSubmit={saveProduct}>
            ...
            <div className="mb-2 flex flex-wrap gap-2">
                ...
                <label className="w-24 h-24 cursor-pointer text-center flex flex-col items-center justify-center p-2 text-sm gap-1 text-primary rounded-lg bg-white shadow-sm border border-primary">
                    <svg
